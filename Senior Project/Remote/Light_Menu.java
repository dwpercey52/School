 ...
 * Intro: Starts up a Light menu for the android app. When a
 * device is register to the main menu as a Light this class
 * will run.
 *********************************************************/
...
public class Light_Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_light__menu);

        //Declares the power button for the light to send codes
        power = (Button) findViewById(R.id.lightButton);

        //Gets the ip from the main menu
